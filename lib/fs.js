...
const getFile = memoize((uploadDate, size, filename) => {
...
export async function listener(request, response) {
    ...
    const buffer = await getFile(file["uploadDate"].getTime(), file.length, filename);
