...
import { insertTasks, awaitSessionEnd, awaitSessionStart, connectionRequest, deleteDevice, } from "../api-functions";
...
export async function postTasks(deviceId, tasks, timeout, device) {
    ...
    for (const s of statuses) {
        ...
        promises.push(db.query("faults", ["=", ["PARAM", "_id"], `${deviceId}:task_${s._id}`]));
    }
...
export function authLocal(snapshot, username, password) {
