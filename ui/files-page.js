...
function upload(file, headers, abortSignal, progressListener) {
    ...
    return {
        view: (vnode) => {
                    ...
                    return [
                            ...
                            onclick: () => {
                                ...
                                const comp = m(putFormComponent, Object.assign({
                                    actionHandler: async (action, obj) => {
                                        ...
                                        const file = (_a = obj["file"]) === null || _a === void 0 ? void 0 : _a[0];
                                        ...
                                        const headers = {
                                            ...
                                            "metadata-productclass": obj["metadata.productClass"] || "",
                                        ...
                                        progress = 0;
                                        try {
                                            await upload(file, headers, abortController.signal, progressListener);
                                            store.setTimestamp(Date.now());
                                ...
                                cb = () => {
                                    if (progress < 0)
                                        return [null, comp];
                                    return [
                                        m("div.progress", m("div.progress-bar", {
                                ...
                                overlay.open(cb, () => {
                                    if (comp.state["current"]["modified"] &&
                        ...
                        m("button.primary", {
                            ...
                            onclick: (e) => {
                                ...
                                Promise.all(Array.from(selected).map((id) => store.deleteResource("files", id)))
                                    .then((res) => {
            ...
            return [
                ...
                m("loading", { queries: [files, count] }, m(indexTableComponent, attrs)),
            ];
        },
    };
};
