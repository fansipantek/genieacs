        ...
        if (action === "save") {
            ...
            store
                ...
                store
                    ...
                    .then(() => {
                    notifications.push("success", `Provision ${exists ? "updated" : "created"}`);
                    store.setTimestamp(Date.now());
                    resolve(null);
                })
                    .catch((err) => {
    ...
    return {
        view: (vnode) => {
                    ...
                    return [
                        ...
                        m("button.primary", {
                            ...
                            onclick: (e) => {
                                ...
                                Promise.all(Array.from(selected).map((id) => store.deleteResource("provisions", id)))
                                    .then((res) => {
            ...
            return [
                ...
                m("loading", { queries: [provisions, count] }, m(indexTableComponent, attrs)),
            ];
        },
    };
};
