...
const component = () => {
    return {
        view: (vnode) => {
            ...
            const { value, timestamp, parameter } = evaluateParam(vnode.attrs["parameter"], device, store.getTimestamp() + store.getClockSkew());
            if (value == null)
                return null;
            let edit;
            if ((_a = device[parameter]) === null || _a === void 0 ? void 0 : _a.writable) {
                edit = m("button", {
