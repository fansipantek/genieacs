...
const evaluateAttributes = memoize((attrs, obj, now // eslint-disable-line @typescript-eslint/no-unused-vars
) => {
    const res = {};
        ...
        view: (vnode) => {
            ...
            if (Array.isArray(el)) {
                ...
                if (el["attributes"] != null) {
                    attrs = evaluateAttributes(el["attributes"], device || {}, getTimestamp());
                }
