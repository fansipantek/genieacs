...
export default class Autocomplete {
    ...
    update() {
        ...
        this.callback(el.value, (suggestions) => {
            ...
            if (selectedElement) {
                this.container.scrollTop = Math.min(this.container.scrollTop, selectedElement.offsetTop);
                this.container.scrollTop = Math.max(this.container.scrollTop, selectedElement.offsetTop +
