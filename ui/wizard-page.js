    ...
    return {
        view: () => {
            ...
            return m(".wizard-dialog", [
                ...
                m("p", "This wizard will seed the database with a minimal initial configuration to serve as a starting point. Select what you want to initialize and click 'ABRACADABRA!'."),
                m("div", m("label", checkboxes[0], "Users, roles and permissions")),
                m("div", m("label", checkboxes[1], "Presets and provisions")),
                m("div", m("label", checkboxes[2], "Devices predefined search filters")),
                ...
                m("button.primary", {
                    ...
                    onclick: (e) => {
                        ...
                        m.request({
                            ...
                            if (opts["users"]) {
                                alert("An administrator user has been created for you. Use admin/admin to log in. Don't forget to change the default password.");
                            }
                        })
                            .catch((err) => {
                            notifications.push("error", err.message);
